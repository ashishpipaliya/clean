...
mixin _$PokemonListModel {
 ...
 int get count; String? get next; String? get previous; List<PokemonModel> get results;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int count,  String? next,  String? previous,  List<PokemonModel> results)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PokemonListModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int count,  String? next,  String? previous,  List<PokemonModel> results)  $default,) {final _that = this;
switch (_that) {
case _PokemonListModel():
return $default(_that.count,_that.next,_that.previous,_that.results);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int count,  String? next,  String? previous,  List<PokemonModel> results)?  $default,) {final _that = this;
switch (_that) {
case _PokemonListModel() when $default != null:
return $default(_that.count,_that.next,_that.previous,_that.results);case _:
  return null;
...
class _PokemonListModel implements PokemonListModel {
  const _PokemonListModel({required this.count, this.next, this.previous, required final  List<PokemonModel> results}): _results = results;
